...
def as_set_ibuki_form_distance_process(form_set_cv0, form_set_cv1, ibuki_form_pairs):
    ...
    for form1, form2 in cv0_form_pairs + cv1_form_pairs:
        ...
        form_distance_list.append(as_set_ibuki_levenshtein_distance)
...
def Spearman_Ibuki_3_TopSim(rule_set):
    ...
    hamming_distance_list = count_hamming_distance_process(split_semantic_elements_set_cv0, split_semantic_elements_set_cv1, split_ibuki_sem_pairs)

    ibuki_form_pairs = ibuki_form_pairing(ibuki_pairs)
    form_set_cv0 = set_form(cv_0_rule_set)
    form_set_cv1 = set_form(cv_1_rule_set)
    form_distance_list = as_set_ibuki_form_distance_process(form_set_cv0, form_set_cv1, ibuki_form_pairs)
    
    spearman_ibuki_3_TopSim, spearman_ibuki_3_p_value = spearmanr(hamming_distance_list, form_distance_list)
    return spearman_ibuki_3_TopSim, spearman_ibuki_3_p_value