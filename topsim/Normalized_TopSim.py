...
def Normalized_TopSim(rule_set):
    ...
    normalized_topsim_values, normalized_p_value = pearsonr(hamming_distance_list, normalized_form_distance_list)
    return normalized_topsim_values, normalized_p_value