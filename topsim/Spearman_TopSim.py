...
def Spearman_TopSim(rule_set):
    ...
    spearman_TopSim_value, spearman_p_value = spearmanr(hamming_distance_list, form_distance_list)
    return spearman_TopSim_value, spearman_p_value