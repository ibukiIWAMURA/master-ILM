...
def Spearman_Ibuki_2_TopSim(rule_set):
    ...
    form_distance_list = ibuki_form_distance_process(form_set_cv0, form_set_cv1, ibuki_form_pairs)
    
    spearman_ibuki_2_TopSim, spearman_ibuki_2_p_value = spearmanr(hamming_distance_list, form_distance_list)
    return spearman_ibuki_2_TopSim, spearman_ibuki_2_p_value