...
def chunk_learning(rule_set):
    ...
    # 3. フォームの変換
    transformed_form_pairs = transformed_set_form(sem_pairs_with_only_one_difference, rule_set)
    ...
    can_chunk_rule_set = final_transformed_set_form(sem_pairs_with_only_one_difference, rule_set, filtered_indices_set)
    ...
    # print("チャンクしたペア", chunk_completed_pairs)
    # チャンク適用回数をカウントする変数を追加
    chunk_applications = len(can_chunk_rule_set)  # can_chunk_rule_set のリスト要素数
...
#     word_rule_set = clustering_rule_set(rule_set)
#     # print('word')
#     print('word_rule_set', word_rule_set)
#     for rule in word_rule_set:
#           rule_set.remove(rule)
...
#     split_form_pairs = split_form_process(transformed_form_pairs)
#     compare_form_pair_results = compare_forms_by_index_process(split_form_pairs)
#     print('compare_form_pair_results', compare_form_pair_results)
#     # 4. インデックスフィルタリングとルールの最終変換
#     check_for_uppercase_warning(compare_form_pair_results) # ---------------------------------------------
#     filtered_indices_set = get_filtered_indices([result for result, _, _ in compare_form_pair_results])
#     print('filtered_indices_set', filtered_indices_set)
#     can_chunk_rule_set = final_transformed_set_form(sem_pairs_with_only_one_difference, rule_set, filtered_indices_set)
#     print('can_chunk_rule_set', can_chunk_rule_set)
#     # 5. セマンティクスチャンクとフォームチャンクの処理
#     transform_only_sem_chunk_pair_sets = transform_only_sem_chunk_pair(can_chunk_rule_set)
#     split_sem_pairs = split_sem_pairs_for_chunk(transform_only_sem_chunk_pair_sets)
#     print('split_sem_pairs', split_sem_pairs,)
#     index_sem_difference_sets = detect_index_sem_difference_process(split_sem_pairs)
#     print('index_sem_difference_sets', index_sem_difference_sets)

#     transform_only_form_chunk_pair_sets = transform_only_form_chunk_pair(can_chunk_rule_set)
#     print('transform_only_form_chunk_pair_sets', transform_only_form_chunk_pair_sets)
#     split_form_pairs = split_form_process(transform_only_form_chunk_pair_sets)
#     print('split_form_pairs', split_form_pairs)
#     index_form_difference_sets = detect_index_form_difference_process(split_form_pairs)
#     print('index_form_difference_sets', index_form_difference_sets)
#     # 6. チャンクの完了とスキーマルール、ワードルールの生成
#     used_labels = used_labels_in_word_rule_set(word_rule_set)
